   ...
   return (
      <div>
         <div className='flex gap-x-5 items-start'>
            {/* img Div */}
            <div className=''>
               <img className='border-2 border-[#E8E8E8] rounded-bl-full rounded-tl-none rounded-tr-full rounded-br-full w-[118px]' src={image} alt={name} referrerPolicy='no-referrer' />
            </div>
            {/* Text div */}
            <div className=''>
